...
var Category = /** @class */ (function () {
     ...
     * @param {response} res
     */
    Category.prototype.create = function (req, res) {
     ...
     * @param {response} res
     */
    Category.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        _id = req.params.id;
                        return [4 /*yield*/, category_1.default.findOneAndUpdate({ _id: _id }, { $set: req.body }, { new: true })];
                    case 1:
                        updated = _a.sent();
     ...
     * @param {response} res
     */
    Category.prototype.findOne = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    return [2 /*return*/, res.send({ success: true })];
